...
const EditSoalStructure = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Kirim data sebagai JSON ke endpoint PUT untuk edit soal
      await axios.put(
        `${process.env.REACT_APP_API_BASE_URL}/admin/paket-soal/soal-structure/${soalId}`, // Endpoint untuk update soal
  ...
  return (
    <div className="max-w-xl mx-auto py-8">
      <h2 className="text-2xl font-bold mb-6">Edit Soal Structure</h2>
...
export default EditSoalStructure;
