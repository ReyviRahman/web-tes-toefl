...
const SoalStructure = () => {
  ...
  const fetchSoalStructure = async () => {
    Swal.fire({
      title: "Memuat data...",
  ...
  return (
    <div>
      <div className='flex items-center justify-between mb-4'>
        <h2 className="text-2xl">Soal Structure {namaPaket}</h2>
        <button
          onClick={() => navigate(`/admin/soal-simulasi/add-soal-structure/${paketId}`, { state: { nama_paket: namaPaket } })}
